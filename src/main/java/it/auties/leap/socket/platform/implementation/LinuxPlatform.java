...
import it.auties.leap.socket.platform.ffi.linux.*;
...
// Io_uring
public final class LinuxPlatform extends SocketPlatform<Integer> {
    private IOUring ioUring;

    public LinuxPlatform(SocketProtocol protocol) {
        super(protocol);
    }
