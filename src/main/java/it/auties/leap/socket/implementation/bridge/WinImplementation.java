...
import it.auties.leap.socket.implementation.foreign.win.*;
import it.auties.leap.socket.implementation.threading.CompletionPort;
...
// Completion Ports
public final class WinImplementation extends ForeignImplementation<Long> {
    ...
    public WinImplementation(SocketProtocol protocol) {
        super(protocol);
    }
