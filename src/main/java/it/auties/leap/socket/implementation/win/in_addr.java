...
public class in_addr {
    ...
    public static class S_un {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            S_un_b.layout().withName("S_un_b"),
            S_un_w.layout().withName("S_un_w"),
            WindowsKernel.C_LONG.withName("S_addr")
        ).withName("$anon$26:9");
        ...
        public static class S_un_b {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                WindowsKernel.C_CHAR.withName("s_b1"),
                WindowsKernel.C_CHAR.withName("s_b2"),
                WindowsKernel.C_CHAR.withName("s_b3"),
                WindowsKernel.C_CHAR.withName("s_b4")
            ).withName("$anon$27:17");
        ...
        public static class S_un_w {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                WindowsKernel.C_SHORT.withName("s_w1"),
                WindowsKernel.C_SHORT.withName("s_w2")
            ).withName("$anon$28:17");
