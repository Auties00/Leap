...
public final class AsyncSOCKSTunnelSocketLayer extends AsyncSocketTunnelLayer {
    ...
    public AsyncSOCKSTunnelSocketLayer(AsyncSocketApplicationLayer applicationLayer, URI proxy) {
    ...
    private CompletableFuture<ByteBuffer> sendAuthenticationRequest() {
        ...
        return applicationLayer.write(ByteBuffer.wrap(connectionPayload.toByteArray()))
    ...
    private CompletionStage<ByteBuffer> sendAuthenticationData(ByteBuffer response) {
        ...
        return applicationLayer.write(ByteBuffer.wrap(outputStream.toByteArray()))
