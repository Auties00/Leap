...
abstract class AsyncNativeSocketClient<HANDLE extends Number> implements AsyncSocketImplementation {
    ...
    public AsyncNativeSocketClient(SocketProtocol protocol) {
