...
public final class SecureTransport extends SocketTransport {
    ...
    public SecureTransport(SocketImplementation channel, TlsEngine.Config tlsConfig) {
        super(channel);
    ...
    public CompletableFuture<Void> handshake() {
        try {
            ...
            synchronized (this) {
                ...
                this.tlsEngine = new TlsEngine(implementation.remoteAddress().orElse(null), tlsConfig);
    ...
    private CompletableFuture<Void> sendClientCertificate() {
        ...
        var certificatesMessage = new CertificateMessage.Client(
                tlsConfig.version(),
                TlsSource.LOCAL,
                certificatesProvider.getCertificates(implementation.remoteAddress().orElse(null))
        );
