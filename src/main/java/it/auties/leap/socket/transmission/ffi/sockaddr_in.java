...
public class sockaddr_in {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        WindowsSockets.C_SHORT.withName("sin_family"),
        WindowsSockets.C_SHORT.withName("sin_port"),
        in_addr.layout().withName("sin_addr"),
        MemoryLayout.sequenceLayout(8, WindowsSockets.C_CHAR).withName("sin_zero")
