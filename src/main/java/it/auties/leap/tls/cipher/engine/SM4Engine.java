...
final class SM4Engine extends TlsCipherEngine.Block {
    ...
    private int[] expandKey(boolean forEncryption, byte[] key) {
        ...
        mk[0] = BufferHelper.readBigEndianInt32(key, 0);
        mk[1] = BufferHelper.readBigEndianInt32(key, 4);
        mk[2] = BufferHelper.readBigEndianInt32(key, 8);
        mk[3] = BufferHelper.readBigEndianInt32(key, 12);
    ...
    public void process(ByteBuffer input, ByteBuffer output) {
        ...
        x[3] = BufferHelper.readBigEndianInt32(input);
        ...
        BufferHelper.writeBigEndianInt32(output, x[3]);
        BufferHelper.writeBigEndianInt32(output, x[2]);
        BufferHelper.writeBigEndianInt32(output, x[1]);
        BufferHelper.writeBigEndianInt32(output, x[0]);
    }
