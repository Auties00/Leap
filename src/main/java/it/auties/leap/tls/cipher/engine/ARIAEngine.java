...
final class ARIAEngine extends TlsCipherEngine.Block {
    ...
    ARIAEngine(boolean forEncryption, byte[] key) {
        super(forEncryption, key);
        this.roundKeys = keySchedule(forEncryption, key);
    }

    private static byte[][] keySchedule(boolean forEncryption, byte[] key) {
    ...
    private static void keyScheduleRound(byte[] rk, byte[] w, byte[] wr, int n) {
