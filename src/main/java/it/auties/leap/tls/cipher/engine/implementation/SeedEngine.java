...
public final class SeedEngine extends TlsCipherEngine.Block {
    ...
    private SeedEngine(boolean forEncryption, byte[] key) {
        super(forEncryption);
    ...
    public void cipher(ByteBuffer input, ByteBuffer output) {
        ...
        if (forEncryption) {
            for (var i = 0; i < 16; i++) {
                ...
                r = l ^ F(workingKey[2 * i], workingKey[(2 * i) + 1], r);
                l = nl;
            }
        } else {
            for (var i = 15; i >= 0; i--) {
