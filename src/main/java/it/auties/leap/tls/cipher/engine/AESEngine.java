...
final class AESEngine extends TlsCipherEngine.Block {
    ...
    private static void handle256BitsKey(byte[] key, int[][] blocks) {
        ...
        var col6 = BufferHelper.readLittleEndianInt32(key, 24);
        blocks[1][2] = col6;

        var col7 = BufferHelper.readLittleEndianInt32(key, 28);
        blocks[1][3] = col7;
    ...
    private void encryptBlock(ByteBuffer input, ByteBuffer output) {
        var c0 = BufferHelper.readLittleEndianInt32(input);
        var c1 = BufferHelper.readLittleEndianInt32(input);
        var c2 = BufferHelper.readLittleEndianInt32(input);
        var c3 = BufferHelper.readLittleEndianInt32(input);
        ...
        BufferHelper.writeLittleEndianInt32(output, c0);
        BufferHelper.writeLittleEndianInt32(output, c1);
        BufferHelper.writeLittleEndianInt32(output, c2);
        BufferHelper.writeLittleEndianInt32(output, c3);
    }
