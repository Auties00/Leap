...
public final class CamelliaEngine extends TlsCipherEngine.Block {
    ...
    private static final TlsCipherEngineFactory FACTORY_128 = () -> new CamelliaEngine(16);
    private static final TlsCipherEngineFactory FACTORY_256 = () -> new CamelliaEngine(32);
