...
final class RC2Engine extends TlsCipherEngine.Block {
    ...
    RC2Engine(boolean forEncryption, byte[] key) {
    ...
    private void encryptBlock(ByteBuffer input, ByteBuffer output) {
        var x10 = BufferHelper.readLittleEndianInt16(input);
        var x32 = BufferHelper.readLittleEndianInt16(input);
        var x54 = BufferHelper.readLittleEndianInt16(input);
        var x76 = BufferHelper.readLittleEndianInt16(input);
        ...
        BufferHelper.writeLittleEndianInt16(output, x10);
        BufferHelper.writeLittleEndianInt16(output, x32);
        BufferHelper.writeLittleEndianInt16(output, x54);
        BufferHelper.writeLittleEndianInt16(output, x76);
    }
