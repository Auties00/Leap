...
public abstract class DESBaseEngine extends TlsCipherEngine.Block {
    ...
    public DESBaseEngine(boolean forEncryption, byte[] key) {
    ...
    protected void desFunc(ByteBuffer input, ByteBuffer output, int[] wKey) {
        var left = readBigEndianInt32(input);
        var right = readBigEndianInt32(input);
        ...
        writeBigEndianInt32(output, right);
        writeBigEndianInt32(output, left);
    }
}
