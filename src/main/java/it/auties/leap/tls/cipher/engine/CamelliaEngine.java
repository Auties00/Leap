...
final class CamelliaEngine extends TlsCipherEngine.Block {
    ...
    private void read256BitKey(byte[] key, int[] k) {
        ...
        k[6] = BufferHelper.readBigEndianInt32(key, 24);
    ...
    private void processBlock128(ByteBuffer input, ByteBuffer output) {
        ...
        BufferHelper.writeBigEndianInt32(output, state[2]);
        BufferHelper.writeBigEndianInt32(output, state[3]);
        BufferHelper.writeBigEndianInt32(output, state[0]);
