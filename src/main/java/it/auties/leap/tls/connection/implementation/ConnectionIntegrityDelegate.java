...
public sealed abstract class ConnectionIntegrityDelegate {
    public static ConnectionIntegrityDelegate of(TlsVersion version, TlsHashFactory hash) {
        return switch (version) {
            ...
            case SSL30 -> new ConnectionIntegrityDelegate.SSL30();
        };
    }
    ...
    private static final class SSL30 extends ConnectionIntegrityDelegate {
        ...
        public byte[] digest() {
            ...
            var offset = md5.digest(digest, false);
            sha1.digest(digest, offset, false);
            return digest;
        }
