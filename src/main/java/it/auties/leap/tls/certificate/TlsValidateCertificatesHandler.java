...
final class TlsValidateCertificatesHandler implements TlsCertificatesHandler {
    static final TlsValidateCertificatesHandler INSTANCE = new TlsValidateCertificatesHandler();
