...
public final class SunValidateCertificatesHandler implements TlsCertificatesHandler {
    private static final SunValidateCertificatesHandler INSTANCE = new SunValidateCertificatesHandler();

    public static SunValidateCertificatesHandler instance() {
        return INSTANCE;
    }
    ...
    private SunValidateCertificatesHandler() {
        try {
