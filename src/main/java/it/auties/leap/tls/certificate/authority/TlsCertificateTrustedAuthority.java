...
public sealed interface TlsCertificateTrustedAuthority extends TlsSerializableProperty {
    ...
    TlsCertificateTrustedAuthorityType type();
    ...
    final class PreAgreed implements TlsCertificateTrustedAuthority {
        ...
        @Override
        public TlsCertificateTrustedAuthorityType type() {
            return TlsCertificateTrustedAuthorityType.PRE_AGREED;
        }
    ...
    final class KeySha1Hash implements TlsCertificateTrustedAuthority {
        ...
        @Override
        public TlsCertificateTrustedAuthorityType type() {
            return TlsCertificateTrustedAuthorityType.KEY_SHA1_HASH;
        }
    ...
    final class X509Name implements TlsCertificateTrustedAuthority {
        ...
        @Override
        public TlsCertificateTrustedAuthorityType type() {
            return TlsCertificateTrustedAuthorityType.X509_NAME;
        }
    ...
    final class CertSha1Hash implements TlsCertificateTrustedAuthority {
        ...
        @Override
        public TlsCertificateTrustedAuthorityType type() {
            return TlsCertificateTrustedAuthorityType.CERT_SHA1_HASH;
        }
