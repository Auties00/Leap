...
public sealed abstract class CamelliaEngine extends TlsCipherEngine.Block {
    ...
    private static final TlsCipherEngineFactory FACTORY_128 = new TlsCipherEngineFactory() {
        ...
        public TlsCipherEngine newCipherEngine(boolean forEncryption, byte[] key) {
            return new Camellia128(forEncryption, key);
        }
    ...
    private static final TlsCipherEngineFactory FACTORY_256 = new TlsCipherEngineFactory() {
        @Override
        public TlsCipherEngine newCipherEngine(boolean forEncryption, byte[] key) {
            return new Camellia256(forEncryption, key);
        }
    ...
    private static final class Camellia128 extends CamelliaEngine {
        private Camellia128(boolean forEncryption, byte[] key) {
    ...
    private static final class Camellia256 extends CamelliaEngine {
        private Camellia256(boolean forEncryption, byte[] key) {
            super(forEncryption, key);
        }
