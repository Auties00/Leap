...
public final class TlsPrf {
    ...
    public static byte[] tls10Prf(byte[] secret, byte[] labelBytes, byte[] seed, int outputLength, TlsHash md5, TlsHash sha) {
        ...
        expand(md5, 16, secKey, 0, keyLen, labelBytes, seed, output, HMAC_IPAD_64.clone(), HMAC_OPAD_64.clone());
        ...
        expand(sha, 20, secKey, off, keyLen, labelBytes, seed, output, HMAC_IPAD_64.clone(), HMAC_OPAD_64.clone());
