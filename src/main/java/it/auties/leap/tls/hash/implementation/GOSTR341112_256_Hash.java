...
public final class GOSTR341112_256_Hash implements TlsHash {
    ...
    public GOSTR341112_256_Hash() {
        this.n = new byte[64];
        this.sigma = new byte[64];
        this.ki = new byte[64];
        this.m = new byte[64];
        this.h = new byte[64];
    ...
    private GOSTR341112_256_Hash(GOSTR341112_256_Hash other) {
        this.n = other.n.clone();
        this.sigma = other.sigma.clone();
        this.ki = other.ki.clone();
        this.m = other.m.clone();
        this.h = other.h.clone();
        this.tmp = other.tmp.clone();
        this.block = other.block.clone();
        this.bOff = other.bOff;
    }
    ...
    public int digest(byte[] buf, int offset, int length, boolean reset) {
        if (reset) {
            ...
            g_N(h, ZERO, sigma);
            reverse(h, tmp);
            System.arraycopy(tmp, length, buf, offset, length);
            reset();
            return length;
        } else {
            var digest = new GOSTR341112_256_Hash(this);
