...
final class SHA384Hash implements TlsHash {
    ...
    private SHA384Hash(SHA384Hash other) {
        this.h1 = other.h1;
        this.h2 = other.h2;
        this.h3 = other.h3;
        this.h4 = other.h4;
    ...
    public int digest(byte[] output, int offset, int length, boolean reset) {
        if (reset) {
            ...
            BufferHelper.writeLittleEndianInt64(h1, output, offset);
            BufferHelper.writeLittleEndianInt64(h2, output, offset + 8);
            BufferHelper.writeLittleEndianInt64(h3, output, offset + 16);
            BufferHelper.writeLittleEndianInt64(h4, output, offset + 24);
            BufferHelper.writeLittleEndianInt64(h5, output, offset + 32);
            BufferHelper.writeLittleEndianInt64(h6, output, offset + 40);

            reset();

            return length;
        } else {
            var digest = new SHA384Hash(this);
    ...
    private void processWord(byte[] in, int inOff) {
        w[wOff] = BufferHelper.readBigEndianInt64(in, inOff);
    ...
    private void processWord(ByteBuffer in) {
        w[wOff] =  BufferHelper.readBigEndianInt64(in);
