...
final class SHA256Hash implements TlsHash {
    ...
    private SHA256Hash(SHA256Hash other) {
        this.h1 = other.h1;
        this.h2 = other.h2;
        this.h3 = other.h3;
        this.h4 = other.h4;
    ...
    private void processWord(byte[] in, int inOff) {
        x[xOff] = BufferHelper.readBigEndianInt32(in, inOff);
    ...
    private void processWord(ByteBuffer in) {
        x[xOff] = BufferHelper.readBigEndianInt32(in);
    ...
    public int digest(byte[] output, int offset, int length, boolean reset) {
        if (reset) {
            ...
            BufferHelper.writeLittleEndianInt32(h5, output, offset + 16);
            BufferHelper.writeLittleEndianInt32(h6, output, offset + 20);
            BufferHelper.writeLittleEndianInt32(h7, output, offset + 24);
            BufferHelper.writeLittleEndianInt32(h8, output, offset + 28);

            reset();

            return length;
        } else {
            var digest = new SHA256Hash(this);
