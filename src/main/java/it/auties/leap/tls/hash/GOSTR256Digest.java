...
public final class GOSTR256Digest implements TlsHashType {
    ...
    private GOSTR256Digest(GOSTR256Digest other) {
    ...
    public int digest(byte[] buf, int offset, int length, boolean reset) {
        if (reset) {
            ...
            var digest = new GOSTR256Digest(this);
