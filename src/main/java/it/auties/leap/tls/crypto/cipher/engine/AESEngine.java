...
final class AESEngine extends TlsCipherEngine.Block {
    ...
    private static void handle128BitsKey(byte[] key, int[][] blocks) {
        var col0 = TlsBuffer.readLittleEndianInt32(key, 0);
        blocks[0][0] = col0;

        var col1 = TlsBuffer.readLittleEndianInt32(key, 4);
        blocks[0][1] = col1;

        var col2 = TlsBuffer.readLittleEndianInt32(key, 8);
        blocks[0][2] = col2;

        var col3 = TlsBuffer.readLittleEndianInt32(key, 12);
        blocks[0][3] = col3;
    ...
    private static void handle192BitsKey(byte[] key, int[][] blocks) {
        ...
        var col4 = TlsBuffer.readLittleEndianInt32(key, 16);
        var col5 = TlsBuffer.readLittleEndianInt32(key, 20);
    ...
    private static void handle256BitsKey(byte[] key, int[][] blocks) {
        ...
        var col6 = TlsBuffer.readLittleEndianInt32(key, 24);
        blocks[1][2] = col6;

        var col7 = TlsBuffer.readLittleEndianInt32(key, 28);
        blocks[1][3] = col7;
    ...
    private void encryptBlock(ByteBuffer input, ByteBuffer output) {
        var c0 = TlsBuffer.readLittleEndianInt32(input);
        var c1 = TlsBuffer.readLittleEndianInt32(input);
        var c2 = TlsBuffer.readLittleEndianInt32(input);
        var c3 = TlsBuffer.readLittleEndianInt32(input);
        ...
        TlsBuffer.writeLittleEndianInt32(output, c0);
        TlsBuffer.writeLittleEndianInt32(output, c1);
        TlsBuffer.writeLittleEndianInt32(output, c2);
        TlsBuffer.writeLittleEndianInt32(output, c3);
    }
