...
final class RC2Engine extends TlsCipherEngine.Block {
    ...
    private void encryptBlock(ByteBuffer input, ByteBuffer output) {
        var x10 = TlsBuffer.readLittleEndianInt16(input);
        var x32 = TlsBuffer.readLittleEndianInt16(input);
        var x54 = TlsBuffer.readLittleEndianInt16(input);
        var x76 = TlsBuffer.readLittleEndianInt16(input);
        ...
        TlsBuffer.writeLittleEndianInt16(output, x10);
        TlsBuffer.writeLittleEndianInt16(output, x32);
        TlsBuffer.writeLittleEndianInt16(output, x54);
        TlsBuffer.writeLittleEndianInt16(output, x76);
    }
