...
non-sealed class DESEngine extends TlsCipherEngine.Block {
    ...
    protected void desFunc(ByteBuffer input, ByteBuffer output, int[] wKey) {
        var left = TlsBuffer.readBigEndianInt32(input);
        var right = TlsBuffer.readBigEndianInt32(input);
        ...
        TlsBuffer.writeBigEndianInt32(output, right);
        TlsBuffer.writeBigEndianInt32(output, left);
    }
