...
public abstract sealed class TlsExchangeAuthenticator {
    ...
    final boolean dtls;
    final TlsHMAC mac;
    private TlsExchangeAuthenticator(TlsHmacType tlsHmacType, Key hmacKey, byte[] block, boolean dtls) {
        this.block = block;
        this.dtls = dtls;
        if(tlsHmacType != null) {
    ...
    private static final class SSL30 extends TlsExchangeAuthenticator {
        ...
        private SSL30(TlsHmacType tlsHmacType, Key hmacKey) {
    ...
    private static final class TLS10 extends TlsExchangeAuthenticator {
        ...
        private TLS10(TlsVersion protocolVersion, TlsHmacType tlsHmacType, Key hmacKey) {
            super(tlsHmacType, hmacKey, new byte[BLOCK_SIZE], false);
    ...
    private static final class DTLS10 extends TlsExchangeAuthenticator {
        ...
        private DTLS10(TlsVersion protocolVersion, TlsHmacType tlsHmacType, Key hmacKey) {
